      ...
      render() {
        ...
        <div>    
            ...
            <form onSubmit={this.handleSubmitMusic}>
                <iframe id ="Spotifyframe" src="https://embed.spotify.com/?uri=spotify:track:5JunxkcjfCYcY7xJ29tLai" frameborder="0" allowtransparency="true" style:height="80px" style:width="250px"></iframe>
                <select id = "SearchFor">
